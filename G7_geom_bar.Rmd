...
1. Seleccione el archivo "Lelto" en el paquete "ggversa".  Seleccione la variable adultos y juvenil, que representa la cantidad de plantas adulto y juvenil que se encuentra en el árbol. Los datos son de una pequeñita orquídea que esta limitado las veredas del "El Toro" y de los "Vientos Alizios" en el Yunque. 
     ...
     - haz un grafico de los adultos y otro de los juveniles
...
Para cambiar el orden de las barras, se puede usar la función **reorder**. En el siguiente ejemplo, se ordenan las barras de mayor a menor.  En el archivo de datos de la *Dipodium rosea*, se observa que la posición de las flores en la inflorescencia se ordena de mayor a menor. 
