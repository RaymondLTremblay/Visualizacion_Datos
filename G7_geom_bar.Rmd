...
2. USando los datos de Anchorage Alaska, evaluar el patrón de temperatura mínima en los diferentes meses del año.  
...
ggplot(data=AA,
  aes(x=FechasMA, y=Temp_min, fill=NegPos)) +
  geom_bar(stat = "identity", position="identity")+
  theme(axis.text.x=element_text(angle=90))+
  guides(fill=FALSE)+
  xlab("Fecha")+
  ylab("Temperatura promedio máxima por mes en Farenheit")+
  theme(axis.title=element_text(size=10,face="bold"))
