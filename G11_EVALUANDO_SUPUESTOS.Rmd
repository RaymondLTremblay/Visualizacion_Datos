...
```{r Homogeneityvariance2}
  ResEst=ggplot(modelflower,
                 ...
                 geom_point(aes(colour = .stdresid >3),na.rm=TRUE)+
  theme(axis.title=element_text(size=20,face="bold"),
        axis.text=element_text(size=20, face="bold"))+
          xlab("Valores estimados")+
...
# hay una nueva funcción en el paquete ggpubr, ggqqplot que incluye los intervalo de confianza
...
Explorando el uso de "everything", "na.or.complete", "all.obs" y "pairwise.complete.obs" con el paquete "corrplot"
...
carros_mini # mirar el df

library(corrplot)
corrplot(corr=cor(carros_mini, use="everything"), method="ellipse")
corrplot(corr=cor(carros_mini, use="na.or.complete"), method="shade")
corrplot(corr=cor(carros_mini, use="pairwise.complete.obs"), method="square")
```
