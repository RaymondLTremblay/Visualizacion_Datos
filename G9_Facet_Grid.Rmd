...
2. Ejercicio para entregar. Valor 10 puntos.  Usando los datos de la orquidea *Lepanthes rubripetala*, una especies de Puerto Rico.  Selecciona la variable Números de Flores en una planta (Num_flowers), El tamaño de las flores (Flower_size) y haga un "box plot" para cada población y en "facet_grid" con la población (Population).  Nota aquí el gráfico, que debería tener.  
    - Cambie los colores de las puntos de las diferentes poblaciones
