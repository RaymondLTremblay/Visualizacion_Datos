...
dipodium %>% 
  ...
  drop_na() %>% 
  ggplot(aes(factor(Number_of_Flowers), Number_of_fruits, fill=factor(Number_of_Flowers)))+
  geom_boxplot(varwidth=TRUE)  # la función varwidth =TRUE cambia el ancho de la barras basado en una formula indicado abajo. Más datos más ancho la barra. 
``` 
...
```{r echo=FALSE, out.width = '70%', out.extra='style="float:right; padding:10px"', fig.cap="La foto es de Peter Nosko de University of Nipissing, North Bay, Canada"}
