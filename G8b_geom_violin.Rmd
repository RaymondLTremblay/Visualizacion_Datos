...
Figura de la caracteristicas morfologicas de la orquídea *Caladenia valida* recolectado


```{r echo=FALSE, out.width = '70%', out.extra='style="float:right; padding:10px"', fig.cap="Caladenia valida, una orquídea terrestre australiana"}

knitr::include_graphics("Graficos/Caladenia_valida_morphological_characters.png")

```

Foto de *Caladenia valida*, una orquídea terrestre australiana.  Foto de Andrew Bould

```{r echo=FALSE, out.width = '60%', fig.cap="Caladenia valida, Foto de Andrew Bould"}
knitr::include_graphics("Graficos/Caladenia_valida_3_A_Bould.jpg")
```
