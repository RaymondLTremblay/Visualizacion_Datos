...
Se suguiere que Ud trata de cumplir con todos los pasos abajo.   El objetivo es de practicar las alternativas disponible en R, RSTUDIO y crear un documento .html.   

Es importante que Ud trata de hacer un documento profesional.   Esto tomara tiempo ap[render y reconocer las diferentes funciones diponioble en RStudio y RMarkdown!!!

Mi sugerencia es que trata de construir el dcomento y despues habla con colegas para comparar como lo logró y resolver problemas.
...
6. Calculate the mean life span of all your decease descendantss
