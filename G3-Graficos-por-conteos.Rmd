...
h=head(Anolis, n=10) # la función *head* es para visualizar las primeros 6 filas
...
h$DATE2=as.Date(h$DATE, "%m/%d/%y") # convertir la columna de fecha de tipo *carácter* a tipo *fecha*
