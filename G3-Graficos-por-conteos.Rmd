...
```{r echo=FALSE}
#chunk_reveal(chunk_name = "geom_point-count", 
...
```{r echo=FALSE}
#chunk_reveal(chunk_name = "detalles",
 #              display_type = c("code", "output"))
```
...
```{r echo=FALSE}
#chunk_reveal(chunk_name = "geom_count1",
 #              display_type = c("code", "output"))
```
...
```{r echo=FALSE}
#chunk_reveal(chunk_name = "geom_count2",
#               display_type = c("code", "output"))
```
...
```{r echo=FALSE}
#chunk_reveal(chunk_name = "geom_count2a",
 #              display_type = c("code", "output"))
```
...
```{r echo=FALSE}
#chunk_reveal(chunk_name = "geom_count4",
#               display_type = c("code", "output"))
```
