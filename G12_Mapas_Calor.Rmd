...
DWCor=round(cor(dipodium[c(3, 6, 7, 8, 9, 13)],
                use="pairwise.complete.obs"),3) # se usa *round* para redondear los valores a tres decimales. 
...
Anolis
DWCorA=round(cor(Anolis[c("SVL", "TAIL", "PERCH_DIAMETER","HEIGHT", "DISTANCE_FROM_CENTERLINE", "TAIL")],
