---
title: "G16 Tablas, Tablas y Tablas"
output:
  html_document:
    css: tutorial.css
   # fig_caption: yes
...
knitr::include_graphics(c("Visualizacion_Datos/Graficos/hex_ggversa.png", "Visualizacion_Datos/Graficos/hex_Visualizacion_Datos.png"))
```
...
AA %>% 
  ...
  tab_style(
    ...
    locations = cells_body(columns=SEX_AGE, rows =c(1,3))
  )
```
...
small_table=AAAA %>% 
  tab_style(
    style = cell_text(
      font = google_font("Playwrite México Guides"), 
      weight = "bold",
      size = px(20)
      ),
    locations = list(
   ...
   tab_style(
    style = cell_text(
    font = google_font("Roboto"), size = px(14)),
    locations = list(
