...
## La función densidad **aes(after_stat(density))**
...
According to data from Our World in Data, the mean world human height is approximately 170.8 cm for men and 164.7 cm for women, with a standard deviation of around 7 cm for both genders. 
## Key points:
