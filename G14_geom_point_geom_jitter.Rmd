...
dipodium %>% select(height_inflo, number_of_flowers) %>% 
ggplot(aes(height_inflo, number_of_flowers))+
  geom_point()+
...
m+geom_point()+
  ...
  scale_colour_gradient2(low="blue",
                         high="red",
                         mid="yellow",
                         midpoint=4)+ # NOTA importante el punto considerado como el color medio 
...
ggplot(Partosub, aes(logGSPC, logNMI, colour=Grupo))+
geom_point()+
  xlab("Log GSPC")+
...
## Geom_jitter y la dispersión en los puntos solapados
