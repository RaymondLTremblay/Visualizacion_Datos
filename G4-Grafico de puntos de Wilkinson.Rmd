...
names(dipodium)
dipodium %>%
  select(number_of_fruits, species_name) %>%  # r representa la especie de Dipodium roseum
  ggplot(aes(number_of_fruits))+
  geom_dotplot(stackratio=.9, 
               fill="yellow", colour = "red")+
  labs(x="Número de Frutos", y="Cantidad")+
...
a+geom_dotplot(fill="blue", colour="red",
  ...
  theme(axis.title=element_text(size=20,
                                face="italic", 
                                colour="orange")) +
  scale_y_continuous(NULL, breaks = NULL) + # remover la información del eje de "y" 
...
grid.arrange(a,b,c,name_graphic, ncol=2) # del paquete gridExtra
```
...
## Organizando los graficos en filas o en columnas
...
## El solapamiento de los puntos con **stackratio** y **dodge**
...
```{r dipodium-puntos6}
a=ggplot(dipodium, aes(number_of_fruits, fill=species_name))
a+geom_dotplot(stackgroups = TRUE, binwidth = .5, method = "histodot", stackratio = 0.4) +
  labs(x="Número de Frutos", y="Frecuencia")+
  theme(axis.title=element_text(size=10,face="bold"))+
  scale_y_continuous(NULL, breaks = NULL)
```
...
a=ggplot(dipodium, aes(number_of_fruits))+
  geom_dotplot(binwidth =2, dotsize=0.3) +
  labs(x="Número de Frutos", y="Frecuencia")+
  theme(axis.title=element_text(size=10,face="bold"))+
  scale_y_continuous(NULL, breaks = NULL)
...
b=ggplot(dipodium, aes(number_of_fruits))+
  ...
  theme(axis.title=element_text(size=10,face="bold"))+
  scale_y_continuous(NULL, breaks = NULL)+
  scale_x_continuous(limits = c(0, 8), breaks = seq(0, 20, by = 1))
